...
- (void)testPutObject
{
    ...
    putObjRequest.filename = @"女生派000007.jpg";//kTestSpecial10;//[fileName lastPathComponent];
...
- (void)testDeviceInfo
{
    //    KSYHardwareInfo *deviceInfo = [KSYHardwareInfo new];
    NSLog(@"----%@",[KSYHardwareInfo getUniqueForDevice]);
