...
#import "KS3YunSDK.h"
NSString *const strLogTestAccessKey = @"IYh4GQWndtnQvmCJWFL4";
NSString *const strLogTestSecretKey = @"1+RBTrWaeT6LaixUV5SGPFpeTa/wZEeZlGzYaZfr";
@implementation KS3Util
+ (NSString *)getAuthorization:(KS3Request *)request
{
    return [KS3Util KSYAuthorizationWithHTTPVerb:strLogTestAccessKey secretKey:strLogTestSecretKey httpVerb:request.httpMethod contentMd5:request.contentMd5 contentType:request.contentType date:request.strDate canonicalizedKssHeader:request.kSYHeader canonicalizedResource:request.kSYResource];
}
