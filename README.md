...
* 增加新的方法：setEndPointWith，在发送请求之前调用，可以设置不同的请求地址，默认的请求地址是：kss.ksyun.com 

### V1.6.0 改动日志 2016-01-21

* 修改下载文件出错没有错误回调的问题


### V1.5.0 改动日志 2016-01-18
...
### V1.4.0 改动日志 2015-12-28

* 修改下载时在后台线程去下载不执行下载回调，导致下载不能成功的bug

### V1.3.0 改动日志 2015-12-04
* 修改在分线程中发起请求长时间不返回的bug
