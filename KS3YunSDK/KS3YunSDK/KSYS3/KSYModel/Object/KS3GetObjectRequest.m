...
- (KS3URLRequest *)configureURLRequest {
  ...
  if (nil != _responseContentType) {
    [queryPramaString appendFormat:@"%@=%@", kKS3QueryParamResponseContentType,
                                   [KS3SDKUtil urlEncode:_responseContentType]];
    [subResouceString appendFormat:@"%@=%@", kKS3QueryParamResponseContentType,
  ...
  if (nil != _responseContentLanguage) {
    ...
    [queryPramaString
        appendFormat:@"%@=%@", kKS3QueryParamResponseContentLanguage,
                     [KS3SDKUtil urlEncode:_responseContentLanguage]];
    [subResouceString appendFormat:@"%@=%@",
                                   kKS3QueryParamResponseContentLanguage,
                                   _responseContentLanguage];
  }
  if (nil != _responseExpires) {
    ...
    [queryPramaString appendFormat:@"%@=%@", kKS3QueryParamResponseExpires,
                                   [KS3SDKUtil urlEncode:_responseExpires]];
    [subResouceString
        appendFormat:@"%@=%@", kKS3QueryParamResponseExpires, _responseExpires];
  }
  if (nil != _responseCacheControl) {
    ...
    [queryPramaString
        appendFormat:@"%@=%@", kKS3QueryParamResponseCacheControl,
                     [KS3SDKUtil urlEncode:_responseCacheControl]];
    [subResouceString appendFormat:@"%@=%@", kKS3QueryParamResponseCacheControl,
  ...
  if (nil != _responseContentDisposition) {
    ...
    [queryPramaString
        appendFormat:@"%@=%@", kKS3QueryParamResponseContentDisposition,
                     [KS3SDKUtil urlEncode:_responseContentDisposition]];
    [subResouceString appendFormat:@"%@=%@",
                                   kKS3QueryParamResponseContentDisposition,
                                   _responseContentDisposition];
  }
  if (nil != _responseContentEncoding) {
    ...
    [queryPramaString
        appendFormat:@"%@=%@", kKS3QueryParamResponseContentEncoding,
                     [KS3SDKUtil urlEncode:_responseContentEncoding]];
    [subResouceString appendFormat:@"%@=%@",
                                   kKS3QueryParamResponseContentEncoding,
                                   _responseContentEncoding];
  }
  if (queryPramaString.length > 0) {
    self.host = [self.host stringByAppendingFormat:@"?%@", queryPramaString];
    self.kSYResource =
        [self.kSYResource stringByAppendingFormat:@"?%@", subResouceString];
  }
